...
const InsightBlogSidebar = () => {
    ...
    const careerPosts = data.allWpPost.edges
        ...
        <SidebarLayout>
            <ArchiveList>
                ...
                {careerBlogMonths.map(careerBlogMonth => (
                    <li>
                        <Link to={`/insights/${careerBlogMonth.slug}`}>{careerBlogMonth.month}</Link>
                    </li>
                ))}
                </ul>
            </ArchiveList>
...
export default InsightBlogSidebar