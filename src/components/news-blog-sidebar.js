...
const NewsBlogSidebar = () => {
    ...
    const careerPosts = data.allWpNewsSingle.edges
        ...
        <SidebarLayout>
            <ArchiveList>
                ...
                {careerBlogMonths.map(careerBlogMonth => (
                    <li>
                        <Link to={`/news/${careerBlogMonth.slug}`}>{careerBlogMonth.month}</Link>
                    </li>
                ))}
                </ul>
            </ArchiveList>
...
export default NewsBlogSidebar